...
public class HomeManagementKeyConstant {
	...
	public static final String  ROLLID="role_id";
	public static final String  PHONE="phone";
	public static final String  STATUS="status";
	public static final String  UPDATETIMESTAMP="upated_timestamp";
	...
	public static final String  USERHISTORY="user_history";
	...
	public static final String URL_PATH = "/ravenhistory/logs";
	public static final String RAVEN_LOG = "/raven_application.log";
