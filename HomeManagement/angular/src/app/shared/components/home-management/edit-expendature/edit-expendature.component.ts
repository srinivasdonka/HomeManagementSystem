...
import {ItemStatus } from 'src/app/shared/enums/item-status.enum';
...
@Component({
  ...
  templateUrl: './edit-expendature.component.html',
  styleUrls: ['./edit-expendature.component.scss']
})
export class EditExpendatureComponent implements OnInit {
  labels: any;
  validations: any;
